...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    secondary: 'bg-white hover:bg-gray-50 text-black border border-gray-300 focus:ring-black',
    danger: 'bg-black hover:bg-gray-800 text-white focus:ring-black',
    ghost: 'bg-transparent hover:bg-gray-100 text-black focus:ring-gray-300'
  };
